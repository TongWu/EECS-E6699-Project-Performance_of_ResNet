...
Original file is located at
    https://colab.research.google.com/drive/1zLI4AMHKF2gnEAK5MKz_zIaJxAZ-AE1d
...
for name, optimizer in optimizers.items():
    ...
    histories[name], training_times[name], models[name] = train_model_with_optimizer(optimizer, 128, 100)

for name, model in models.items():
    model.save(f'/content/drive/MyDrive/VGGNet/Model/resnet_model_{name}.h5')
...
plt.savefig('/content/drive/MyDrive/VGGNet/Results/Train_Loss_nopadam.png', dpi=300, bbox_inches='tight')
plt.show()
...
# Save the figure before displaying it
plt.savefig('/content/drive/MyDrive/VGGNet/Results/Test_Error_nopadam.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/content/drive/MyDrive/VGGNet/Results/validation_accuracy_nopadam.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/content/drive/MyDrive/VGGNet/Results/training_time_nopadam.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('/content/drive/MyDrive/VGGNet/Results/matrix_nopadam.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('Training Loss Comparison for Different Optimizers')
# Save the figure before displaying it
plt.savefig('/content/drive/MyDrive/VGGNet/Results/Train_Loss.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('Test Error Comparison for Different Optimizers')
# Save the figure before displaying it
plt.savefig('/content/drive/MyDrive/VGGNet/Results/Test_Error.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/content/drive/MyDrive/VGGNet/Results/validation_accuracy.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('/content/drive/MyDrive/VGGNet/Results/training_time.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('/content/drive/MyDrive/VGGNet/Results/matrix.png', dpi=300, bbox_inches='tight')
plt.show()