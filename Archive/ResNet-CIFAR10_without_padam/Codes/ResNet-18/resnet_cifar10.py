...
This notebook is to compare the performance of different optimisers on ResNet 18 and tiny ResNet architecture.
...
plt.title('Training Loss Comparison for Different Optimizers')
# Save the figure before displaying it
plt.savefig('./Results/Train_Loss_200epochs.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.title('Test Error Comparison for Different Optimizers')
# Save the figure before displaying it
plt.savefig('./Results/Test_Error_200epochs.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('./Results/validation_accuracy_200epochs.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.savefig('./Results/training_time_200epochs.png', dpi=300, bbox_inches='tight')
plt.show()
...
plt.tight_layout()
plt.savefig('./Results/matrix_200epochs.png', dpi=300, bbox_inches='tight')
plt.show()